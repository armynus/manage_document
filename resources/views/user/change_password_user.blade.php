                        ...
                        <div class="col-lg-8">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Đổi mật khẩu người dùng</h1>
                                </div>
                                @php
                                ...
                                @endphp
                                <form class="user" action="{{route('change_password_user')}}" method="POST" enctype="multipart/form-data" id="form_add_user">
                                    @csrf
