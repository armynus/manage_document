<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1 dropdown-notifications" >
                            <a class="nav-link dropdown-toggle view_detail_document"   id="alertsDropdown" role="button" data-toggle="dropdown"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="{{route('history_post_user')}}">Xem Tất Cả</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{route('change_password_us',$user_id)}}">
                                    <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Đổi Mật Khẩu
                                </a>
                                <div class="dropdown-divider"></div> 
                                <a class="dropdown-item" href="{{route('logout_user')}}" data-toggle="modal" data-target="#logoutModal">
                    ...
                    <!-- <a class="dropdown-item d-flex align-items-center " href="{{url('detail_document/',)}}">
                                        <input type="hidden" name="document_id"  value="`+data_pusher.document_id+`">
                                        <div class="mr-3">
                                            ...
                                            <div>
                                                <div class="small text-gray-500">`+data_pusher.created_at+`</div>
                                                <span class="font-weight-bold">`+data_pusher.user_post+` đã thêm văn bản `+data_pusher.document_number+` `+data_pusher.document_id+` </span>
                                        </div>
                                    </a> -->
                <script>
                    $(document).ready(function(){
                        $('.view_detail_document').on('click',function(){
                            $.ajax({
                                url: '{{route('view_detail_document')}}',
                                method: 'GET',
                                data:{
