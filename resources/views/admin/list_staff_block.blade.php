...
<head>
    ...
    <title>Danh sách khóa nhân viên</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Bảng danh sách tài khoản đã khóa</h1>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                                ...
                                                <td style="justify-content: center; align-items: flex-start; text-align: center;">
                                                    ...
                                                    <a href="{{route('edit_user', $staff->id)}}" class="btn btn-info btn-icon-split">
                                                        <span class="text">
                                                    ...
                                                    <div  class="btn btn-success btn-icon-split">
                                                        <span class="icon text-white-50 cancel_order unlock_user"  data-user_id="{{$staff->id}}">
                                        ...
                                        @endforeach
                                        @include('admin.layouts.ajax_account')
                                    </tbody>
                                </table>
                            </div>
                        </div>
